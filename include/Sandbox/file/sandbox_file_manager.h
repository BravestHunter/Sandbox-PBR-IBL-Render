...
namespace sandbox_file
{
  class SandboxFileManager : public IFileManager
  {
   public:
    ...
    virtual sandbox_utils::OperationResult LoadImage(const std::string path, sandbox_utils::Image &image) override;
    virtual sandbox_utils::OperationResult FreeImage(sandbox_utils::Image &image) override;
  };
}
